...
* Студент: [Павел Цыганов](https://up.htmlacademy.ru/htmlcss/18/user/99239).
* Наставник: `Его нет`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/99239-device) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
